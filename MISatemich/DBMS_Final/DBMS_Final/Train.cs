...
namespace DBMS_Final
{
    public partial class Train : Form
    {
        ...
        private void TrCapTb_TextChanged(object sender, EventArgs e)
        {
            
        }

        private void TrCapTb_KeyPress(object sender, KeyPressEventArgs e)
        {

        }

        private void TrCapTb_Leave(object sender, EventArgs e)
        {
           
        }

        private void TrCapTb_Validated(object sender, EventArgs e)
        {
            int box_int = 0;
            Int32.TryParse(TrCapTb.Text, out box_int);
            if (box_int < 1 && TrCapTb.Text != "")
            {
                TrCapTb.Text = "1";
                MessageBox.Show("Minimum allowed is 1");
                TrCapTb.Clear();
            }
            else if (box_int > 200 && TrCapTb.Text != "")
            {
                MessageBox.Show("Maximum allowed is 200");
                TrCapTb.Clear();
            }
        }
    }
