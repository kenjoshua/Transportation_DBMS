...
namespace DBMS_Final
{
    public partial class Passenger : Form
    {
        ...
        private void populate()
        {
            ...
            cmd.CommandText = "select * from PASSENGERTBLN";
            cmd.ExecuteNonQuery();
        ...
        private void button_WOC1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Con.Open();
                    string Query = "Insert into PASSENGERTBLN values('" + TbPName.Text + "','" + TbAddress.Text + "','" + gender + "','"+Nationality.SelectedItem.ToString()+"','"+TbContact.Text+ "','" + CBPWDN.SelectedItem.ToString() + "')";
        ...
        private void button_WOC2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Con.Open();
                    string Query = "update PASSENGERTBLN set PName='" + TbPName.Text + "', PAdd='" + TbAddress.Text + "', PGender='" + gender + "',PPWD='" + pwdstats + "', PNat='" + Nationality.SelectedItem.ToString() + "', PPhone='" + TbContact.Text + "', PPWD='" + CBPWDN.SelectedItem.ToString() + "where PId=" + ID_Edit.Text + ";";
                    SqlCommand cmd = new SqlCommand(Query, Con);
                    cmd.ExecuteNonQuery();
        ...
        private void button_WOC3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = Con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from PASSENGERTBLN where PId='" + ID_Delete.Text + "'";
            cmd.ExecuteNonQuery();
            Con.Close();
            populate();
